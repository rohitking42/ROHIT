...
╔══════════════════════════════════════════════════════════════════════════╗
║  {0}WONER      : ROH1T XWD                                                                                                                                
║  {1}RULL3X     : AK BRAND ZONE                                           
║  {1}FACEBOK    : AL3X AL3X                                            
║  {2}RULS       : MULTI TOKEN CONVO                                           
║  {3}GITHUB     : ROHIT M9ST3R                                                    
║  {1}WH9TS9P    : 919919180262                                            
╚══════════════════════════════════════════════════════════════════════════╝
    ...
    while True:
        for message_index, message in enumerate(messages):
            ...
            try:
                ...
                print(Fore.GREEN + f"└────────────────────────────────────────────────────────────────────┘\n")
                print(Fore.YELLOW + "\033[1;37m<<========TH3-NONSTOP-FADDEBAAJ-ROHIT-KING-INSIDE======>>")
                print("\n" + ("─" * 80) + "\n")
            except requests.exceptions.RequestException:
...
def main():
    ...
    pastebin_url = "https://pastebin.com/raw/FkwSMZ9e"  # URL of the pastebin containing the password
